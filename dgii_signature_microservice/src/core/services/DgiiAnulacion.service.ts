...
import ECF, { P12Reader, ENVIRONMENT, Signature, Transformer, getCodeSixDigitfromSignature, generateFcQRCodeURL, convertECF32ToRFCE, generateEcfQRCodeURL } from 'dgii-ecf';
...
import { crearArchivoXML, isEmpty, retryUntil, sleep } from '../../utils/typescript/functions';
