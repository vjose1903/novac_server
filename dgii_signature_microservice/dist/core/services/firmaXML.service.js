...
exports.FirmaXMLService = void 0;
...
class FirmaXMLService {
    constructor() {
        ...
        this.c14nCanonicalization = function (node, options) {
            options = options || {};
        ...
        this.c14nCanonicalizationInterno = function (node, prefixesInScope, defaultNs, defaultNsForPrefix, ancestorNamespaces) {
            if (node.nodeType === 8)
                return this.renderComment(node);
            if (node.data)
                return this.encodeSpecialCharactersInText(node.data);
            let i;
            let pfxCopy;
        ...
        this.renderComment = function (node) {
        ...
        this.renderAttrs = function (node, defaultNS) {
            var a;
            let i;
            let attr;
            let res = [];
        ...
        this.renderNs = function (node, prefixesInScope, defaultNs, defaultNsForPrefix, ancestorNamespaces) {
            let a;
            let i;
            let p;
            let attr;
    ...
    */
    ...
    agregarEstructuraFirma(xml, PEM, digestValue) {
    ...
    static get_xml_special_to_encoded_text(attributeValue) {
    ...
    encodeSpecialCharactersInText(text) {
        var _text = text;
    ...
    encodeSpecialCharactersInAttribute(attributeValue) {
        return attributeValue.replace(/([&<"\r\n\t])/g, function (str, item) {
            return FirmaXMLService.get_xml_special_to_encoded_text(item);
        });
    }
}
exports.FirmaXMLService = FirmaXMLService;
