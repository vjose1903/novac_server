...
G_CONFIG_ENTIDAD_CUENTA = [
  { descripcion: 'CXC clientes',                      key: 'cobrar',             entidad: 'cliente',          is_nacional: true,    has_comun: true,  is_control: true,  cuenta_contable_descripcion: 'CUENTAS POR COBRAR CLIENTES' },
  { descripcion: 'CXP suplidores moneda nacional',    key: 'pagar',              entidad: 'suplidor',         is_nacional: true,    has_comun: true,  is_control: true,  cuenta_contable_descripcion: 'CUENTAS POR PAGAR PROVEEDORES MONEDA NACIONAL' },
  { descripcion: 'CXP suplidores moneda extranjera',  key: 'pagar',              entidad: 'suplidor',         is_nacional: false,   has_comun: true,  is_control: true,  cuenta_contable_descripcion: 'CUENTAS POR PAGAR PROVEEDORES MONEDA EXTRANJERA' },
  { descripcion: 'CXC empleados',                     key: 'cobrar',             entidad: 'user',             is_nacional: true,    has_comun: true,  is_control: true,  cuenta_contable_descripcion: 'CUENTAS POR COBRAR EMPLEADOS' },
  { descripcion: 'CXP empleados',                     key: 'pagar',              entidad: 'user',             is_nacional: true,    has_comun: true,  is_control: true,  cuenta_contable_descripcion: 'CUENTAS POR PAGAR EMPLEADOS' },
  { descripcion: 'Retenciones empleados',             key: 'retencion',          entidad: 'user',             is_nacional: true,    has_comun: true,  is_control: true,  cuenta_contable_descripcion: 'RETENCIONES A EMPLEADOS' },
  { descripcion: 'Efectivo banco moneda nacional',    key: 'efectivo_banco',     entidad: 'cuenta_bancaria',  is_nacional: true,    has_comun: true,  is_control: true,  cuenta_contable_descripcion: 'EFECTIVO EN BANCO MONEDA NACIONAL' },
  { descripcion: 'Efectivo banco moneda extranjera',  key: 'efectivo_banco',     entidad: 'cuenta_bancaria',  is_nacional: false,   has_comun: true,  is_control: true,  cuenta_contable_descripcion: 'EFECTIVO EN BANCO MONEDA EXTRANJERA' },
  { descripcion: 'Inventario',                        key: 'inventario',         entidad: 'articulo',         is_nacional: true,    has_comun: true,  is_control: true,  cuenta_contable_descripcion: 'INVENTARIOS' },
  { descripcion: 'Ventas',                            key: 'ventas',             entidad: 'articulo',         is_nacional: true,    has_comun: true,  is_control: true,  cuenta_contable_descripcion: 'VENTAS GENERALES' },
  { descripcion: 'Descuentos de ventas',              key: 'descuento_ventas',   entidad: 'articulo',         is_nacional: true,    has_comun: false, is_control: false, cuenta_contable_descripcion: 'DESCUENTOS SOBRE VENTAS GENERALES' },
  { descripcion: 'Compras',                           key: 'compras',            entidad: 'articulo',         is_nacional: true,    has_comun: true,  is_control: true,  cuenta_contable_descripcion: 'COMPRAS GENERALES' },
  { descripcion: 'Descuentos de compras',             key: 'descuento_compras',  entidad: 'articulo',         is_nacional: true,    has_comun: false, is_control: false, cuenta_contable_descripcion: 'DESCUENTOS SOBRE COMPRAS GENERALES' },
]