...
G_PERMISOS = [
	...
	{ nombre:"sesion de usuario",             mostrar_front: false,    descripcion: "device",                  controlador: "devise_token_auth/sessions",     acciones: [{nombre:"iniciar sesión",mostrar_front: true, descripcion: "login", metodo: "create"}]},
