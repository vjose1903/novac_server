...
### Entidad actual
Empezar por la **#1 `articulo_serializer.rb` → `contenido_articulos`**. Al terminar y validar cada una, marcar la casilla correspondiente abajo y avanzar a la siguiente.
...
- [ ] A1 `articulo_serializer` (contenido_articulos)
