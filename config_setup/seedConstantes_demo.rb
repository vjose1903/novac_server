...
G_PERMISOS = [
  ...
  { nombre: 'calendario',                     mostrar_front: true,     descripcion: 'calendario',                       controlador: 'Calendar::Events',               acciones: [*ACCIONES_COMUNES, *ACCION_DESTROY, {nombre:'ver tipos de evento', mostrar_front: true, descripcion: 'read_event_types', metodo: 'eventTypes'}, {nombre:'crear tipos de evento', mostrar_front: true, descripcion: 'create_event_type', metodo: 'createEventType'}, {nombre:'editar tipos de evento', mostrar_front: true, descripcion: 'update_event_type', metodo: 'updateEventType'}, {nombre:'desactivar tipos de evento', mostrar_front: true, descripcion: 'destroy_event_type', metodo: 'destroyEventType'}, {nombre:'buscar entidades relacionables', mostrar_front: true, descripcion: 'search_linkables', metodo: 'searchLinkables'} ]},
  { nombre: 'cuadres caja',                  mostrar_front: true,     descripcion: 'cuadre_caja',                       controlador: 'CuadreCajas',                    acciones: [*ACCIONES_COMUNES, *ACCION_DESTROY, {nombre:'verificar cuadre del dia',mostrar_front: true, descripcion: 'check_today_cuadre', metodo: 'checkTodayCuadre'}, {nombre:'preparar cuadre',mostrar_front: true, descripcion: 'prepare', metodo: 'prepare'}, {nombre:'previsualizar ingresos del sistema',mostrar_front: true, descripcion: 'system_income_preview', metodo: 'systemIncomePreview'}, {nombre:'enviar cuadre',mostrar_front: true, descripcion: 'submit', metodo: 'submit'}, {nombre:'aprobar cuadre',mostrar_front: true, descripcion: 'approve', metodo: 'approve'}, {nombre:'rechazar cuadre',mostrar_front: true, descripcion: 'reject', metodo: 'reject'}, {nombre:'reabrir cuadre',mostrar_front: true, descripcion: 'reopen', metodo: 'reopen'}, {nombre:'configuracion cuadre',mostrar_front: true, descripcion: 'configuracion_cuadre', metodo: nil} ]},
...
G_CONFIG_CUADRES = { target_fondo: 0 }