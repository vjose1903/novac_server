...
G_DIVISA_DEFAULT = [
  ...
  { nombre: 'Dolar Estadounidense', simbolo: 'US$', is_principal: false, estado: true, current_tasa: 56, predeterminado: true, imagenes: { file_name: 'dolar_estadounidense.png', base_64: G_IMG_DOLAR } },
]