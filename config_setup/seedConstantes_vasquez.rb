...
CREATE_ACTION_CONTABILIDAD   = { nombre:'crear',       mostrar_front: false, descripcion: 'create',    metodo: 'create' }
READ_ALL_ACTION_CONTABILIDAD  = { nombre:'ver todos',   mostrar_front: false, descripcion: 'read_all',  metodo: 'index'}
READ_ONE_ACTION_CONTABILIDAD  = { nombre:'buscar uno',  mostrar_front: false, descripcion: 'read_one',  metodo: 'show'}
UPDATE_ACTION_CONTABILIDAD    = { nombre:'editar',      mostrar_front: false, descripcion: 'update',    metodo: 'update'}

ACCIONES_COMUNES_CONTABILIDAD = [ CREATE_ACTION_CONTABILIDAD, READ_ALL_ACTION_CONTABILIDAD, READ_ONE_ACTION_CONTABILIDAD, UPDATE_ACTION_CONTABILIDAD ]

ACCION_DESTROY_CONTABILIDAD = [{ nombre:'eliminar', mostrar_front: false, descripcion: 'destroy', metodo: 'destroy'}]
...
G_PERMISOS = [
  ...
  { nombre:'roles',                               mostrar_front: true,     descripcion: 'role',                            controlador: 'Roles',                          acciones: [ *ACCIONES_COMUNES, *ACCION_DESTROY, {nombre:'buscar filtrados',mostrar_front: true, descripcion: 'get_filtrados', metodo: 'getRolesFiltrados'}]},
	...
	{ nombre:'periodo fiscal',                      mostrar_front: false,    descripcion: 'periodo_fiscal',                  controlador: 'PeriodoFiscal',                  acciones: [ *ACCIONES_COMUNES_CONTABILIDAD, *ACCION_DESTROY_CONTABILIDAD, { nombre:'abrir nuevo periodo', mostrar_front: false, descripcion: 'open_new_periodo', metodo: 'openNewPeriodo' }]},
  { nombre:'grupos de cuentas contables',         mostrar_front: false,    descripcion: 'grupo_cuenta',                    controlador: 'GrupoCuenta',                    acciones: [ *ACCIONES_COMUNES_CONTABILIDAD, *ACCION_DESTROY_CONTABILIDAD ]},
  { nombre:'cuentas contables',                   mostrar_front: false,    descripcion: 'cuenta_contable',                 controlador: 'CuentaContable',                 acciones: [ *ACCIONES_COMUNES_CONTABILIDAD, *ACCION_DESTROY_CONTABILIDAD ]},
  { nombre:'cuentas contables',                   mostrar_front: false,    descripcion: 'cuenta_contable',                 controlador: 'CuentaContable',                 acciones: [ *ACCIONES_COMUNES_CONTABILIDAD, *ACCION_DESTROY_CONTABILIDAD ]},
  { nombre:'cierre de cuentas contables',         mostrar_front: false,    descripcion: 'cierre_cuenta',                   controlador: 'CierreCuenta',                   acciones: [ *ACCIONES_COMUNES_CONTABILIDAD, *ACCION_DESTROY_CONTABILIDAD ]},
  { nombre:'configuracion cuentas contables',     mostrar_front: false,    descripcion: 'configuracion_entidad_cuenta',    controlador: 'ConfiguracionEntidadCuenta',     acciones: [ READ_ALL_ACTION_CONTABILIDAD, READ_ONE_ACTION_CONTABILIDAD, UPDATE_ACTION_CONTABILIDAD ]},
  { nombre:'divisa',                              mostrar_front: false,    descripcion: 'divisa',                          controlador: 'Divisa',                         acciones: [ *ACCIONES_COMUNES_CONTABILIDAD, *ACCION_DESTROY_CONTABILIDAD ]},
  { nombre:'tasa de cambio',                      mostrar_front: false,    descripcion: 'tasa_cambio',                     controlador: 'TasaCambio',                     acciones: [ READ_ALL_ACTION_CONTABILIDAD, READ_ONE_ACTION_CONTABILIDAD, UPDATE_ACTION_CONTABILIDAD, {nombre:'obtener historicos de tasas de cambio', mostrar_front: false, descripcion: 'get_history_changes', metodo: 'getHistoryChanges'} ]},
  { nombre:'tipo de cuenta bancaria',             mostrar_front: false,    descripcion: 'tipo_cuenta_bancaria',            controlador: 'TipoCuentaBancaria',             acciones: [ *ACCIONES_COMUNES_CONTABILIDAD, *ACCION_DESTROY_CONTABILIDAD ]},
  { nombre:'banco',                               mostrar_front: false,    descripcion: 'banco',                           controlador: 'Banco',                          acciones: [ *ACCIONES_COMUNES_CONTABILIDAD, *ACCION_DESTROY_CONTABILIDAD ]},
  { nombre:'cuenta_bancaria',                     mostrar_front: false,    descripcion: 'cuenta_bancaria',                 controlador: 'CuentaBancaria',                 acciones: [ *ACCIONES_COMUNES_CONTABILIDAD, *ACCION_DESTROY_CONTABILIDAD ]},
  { nombre:'asiento contable',                    mostrar_front: false,    descripcion: 'cabeza_asiento_contable',         controlador: 'CabezaAsientoContable',          acciones: [ *ACCIONES_COMUNES_CONTABILIDAD, *ACCION_DESTROY_CONTABILIDAD ]},
  { nombre:'categoria de entidad contable',       mostrar_front: false,    descripcion: 'categoria_entidad_contable',      controlador: 'CategoriaEntidadContable',       acciones: [ *ACCIONES_COMUNES_CONTABILIDAD ]},
  { nombre:'entidad cuenta contable',             mostrar_front: false,    descripcion: 'entidad_cuenta_contable',         controlador: 'EntidadCuentaContable',          acciones: [ *ACCIONES_COMUNES_CONTABILIDAD ]},
  { nombre:'deposito',                            mostrar_front: false,    descripcion: 'deposito',                        controlador: 'Deposito',                       acciones: [ *ACCIONES_COMUNES_CONTABILIDAD, {nombre:'anular deposito', mostrar_front: false, descripcion: 'anular_deposito', metodo: 'anularDeposito'} ]},
  { nombre:'transferencia',                       mostrar_front: false,    descripcion: 'transferencia',                   controlador: 'Transferencia',                  acciones: [ *ACCIONES_COMUNES_CONTABILIDAD, {nombre:'anular transferencia', mostrar_front: false, descripcion: 'anular_transferencia', metodo: 'anularTransferencia'} ]},
  { nombre:'cheque',                              mostrar_front: false,    descripcion: 'cheque',                          controlador: 'Cheque',                         acciones: [ *ACCIONES_COMUNES_CONTABILIDAD, { nombre:'anular cheque', mostrar_front: false, descripcion: 'anular_cheque', metodo: 'anularCheque'}, { nombre: 'buscar filtrados', mostrar_front: false, descripcion: 'get_filtrados', metodo: 'getChequesFiltrados' } ]},
  { nombre:'Recepcion Ecf',                       mostrar_front: false,    descripcion: 'ecf_reception',                   controlador: 'EcfReception',                   acciones: [READ_ALL_ACTION, READ_ONE_ACTION, { nombre: 'Responder recibo de factura', mostrar_front: true, descripcion: 'response_receive', metodo: 'approveDenyEcf'}]},
