...
G_PERMISOS = [
  ...
  { nombre:'pago facturas compra',                  mostrar_front: true,     descripcion: 'pagos_compras',                    controlador: 'PagoFactura',                    acciones: [ *ACCIONES_COMUNES, {nombre:'buscar filtrados',mostrar_front: true, descripcion: 'get_filtrados', metodo: 'getPagosFiltrados'}, {nombre:'revertir pago', mostrar_front: true, descripcion: 'revertir_pago', metodo: 'revertirPagos'} ]},
	...
	{ nombre:'periodo fiscal',                        mostrar_front: false,     descripcion: 'periodo_fiscal',                   controlador: 'PeriodoFiscal',                  acciones: [ *ACCIONES_COMUNES, *ACCION_DESTROY, { nombre:'abrir nuevo periodo', mostrar_front: true, descripcion: 'open_new_periodo', metodo: 'openNewPeriodo' }]},
  { nombre:'grupos de cuentas contables',           mostrar_front: false,     descripcion: 'grupo_cuenta',                     controlador: 'GrupoCuenta',                    acciones: [ *ACCIONES_COMUNES, *ACCION_DESTROY ]},
  { nombre:'cuentas contables',                     mostrar_front: false,     descripcion: 'cuenta_contable',                  controlador: 'CuentaContable',                 acciones: [ *ACCIONES_COMUNES, *ACCION_DESTROY ]},
  { nombre:'cuentas contables',                     mostrar_front: false,     descripcion: 'cuenta_contable',                  controlador: 'CuentaContable',                 acciones: [ *ACCIONES_COMUNES, *ACCION_DESTROY ]},
  { nombre:'cierre de cuentas contables',           mostrar_front: false,     descripcion: 'cierre_cuenta',                    controlador: 'CierreCuenta',                   acciones: [ *ACCIONES_COMUNES, *ACCION_DESTROY ]},
  ...
  { nombre:'divisa',                                mostrar_front: false,     descripcion: 'divisa',                           controlador: 'Divisa',                         acciones: [ *ACCIONES_COMUNES, *ACCION_DESTROY ]},
  { nombre:'tasa de cambio',                        mostrar_front: false,     descripcion: 'tasa_cambio',                      controlador: 'TasaCambio',                     acciones: [ {nombre:'ver todos', mostrar_front: true, descripcion: 'read_all', metodo: 'index'}, {nombre:'buscar uno', mostrar_front: true, descripcion: 'read_one', metodo: 'show'}, {nombre:'editar', mostrar_front: true, descripcion: 'update', metodo: 'update'}, {nombre:'obtener historicos de tasas de cambio', mostrar_front: true, descripcion: 'get_history_changes', metodo: 'getHistoryChanges'} ]},
  { nombre:'tipo de cuenta bancaria',               mostrar_front: false,     descripcion: 'tipo_cuenta_bancaria',             controlador: 'TipoCuentaBancaria',             acciones: [ *ACCIONES_COMUNES, *ACCION_DESTROY ]},
  { nombre:'banco',                                 mostrar_front: false,     descripcion: 'banco',                            controlador: 'Banco',                          acciones: [ *ACCIONES_COMUNES, *ACCION_DESTROY ]},
  { nombre:'cuenta_bancaria',                       mostrar_front: false,     descripcion: 'cuenta_bancaria',                  controlador: 'CuentaBancaria',                 acciones: [ *ACCIONES_COMUNES, *ACCION_DESTROY ]},
  { nombre:'asiento contable',                      mostrar_front: false,     descripcion: 'cabeza_asiento_contable',          controlador: 'CabezaAsientoContable',          acciones: [ *ACCIONES_COMUNES, *ACCION_DESTROY ]},
  { nombre:'categoria de entidad contable',         mostrar_front: false,     descripcion: 'categoria_entidad_contable',       controlador: 'CategoriaEntidadContable',       acciones: [ *ACCIONES_COMUNES ]},
  { nombre:'entidad cuenta contable',               mostrar_front: false,     descripcion: 'entidad_cuenta_contable',          controlador: 'EntidadCuentaContable',          acciones: [ *ACCIONES_COMUNES ]},
  { nombre:'deposito',                              mostrar_front: false,     descripcion: 'deposito',                         controlador: 'Deposito',                       acciones: [ *ACCIONES_COMUNES, {nombre:'anular deposito', mostrar_front: true, descripcion: 'anular_deposito', metodo: 'anularDeposito'} ]},
  { nombre:'transferencia',                         mostrar_front: false,     descripcion: 'transferencia',                    controlador: 'Transferencia',                  acciones: [ *ACCIONES_COMUNES, {nombre:'anular transferencia', mostrar_front: true, descripcion: 'anular_transferencia', metodo: 'anularTransferencia'} ]},
]
