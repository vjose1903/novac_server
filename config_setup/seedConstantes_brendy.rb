...
G_PERMISOS = [
	...
	{ nombre:'facturas venta',                        mostrar_front: true,     descripcion: 'factura_venta',                    controlador: 'CabeceraFacturas',               acciones: [ *ACCIONES_COMUNES, {nombre:'buscar facturas por parametros',mostrar_front: true, descripcion: 'get_facturas_by_params', metodo: 'getFacturasByParams'}, {nombre:'comprobar serial',mostrar_front: true, descripcion: 'comprobar_serial', metodo: 'comprobarSerial'}, {nombre:'verificar si puede editar',mostrar_front: true, descripcion: 'verificate_can_update_id', metodo: 'verificateCanUpdateById'}, {nombre:'buscar viajes sin completar',mostrar_front: false, descripcion: 'get_viajes_sin_completar', metodo: 'getViajesSinCompletar'}, {nombre:'buscar facturas por cliente y estado',mostrar_front: true, descripcion: 'get_facturas_by_cliente_estado', metodo: 'getFacturasByClienteIdAndEstado'}, {nombre:'cancelar factura',mostrar_front: true, descripcion: 'cancelar_factura', metodo: 'cancelarFactura'}, {nombre:'seleccionar camion en facturacion',mostrar_front: false, descripcion: 'seleccionar_camion_en_facturacion', metodo: nil}]},
	...
	{ nombre:'pre venta',                             mostrar_front: true,     descripcion: 'pre_venta',                        controlador: 'CabeceraFacturas',               acciones: [ *ACCIONES_COMUNES, {nombre:'comprobar serial',mostrar_front: true, descripcion: 'comprobar_serial', metodo: 'comprobarSerial'}]},
  ...
  { nombre:'pago facturas compra',                  mostrar_front: true,     descripcion: 'pagos_compras',                    controlador: 'PagoFactura',                    acciones: [ *ACCIONES_COMUNES, {nombre:'buscar filtrados',mostrar_front: true, descripcion: 'get_filtrados', metodo: 'getPagosFiltrados'}, {nombre:'revertir pago', mostrar_front: true, descripcion: 'revertir_pago', metodo: 'revertirPagos'} ]},
	{ nombre:'reportes',                              mostrar_front: true,     descripcion: 'reporte',                          controlador: 'Reportes',                       acciones: [ {nombre:'cuadre de caja', mostrar_front: true, descripcion: 'cuadre', metodo: 'getReportes'}, {nombre:'ventas diarias', mostrar_front: true, descripcion: 'ventas_diarias', metodo: 'getReportes'}, {nombre:'ventas en rango', mostrar_front: true, descripcion: 'ventas_rango', metodo: 'getReportes'}, {nombre:'ventas de productos', mostrar_front: true, descripcion: 'ventas_productos', metodo: 'getReportes'}, {nombre:'cuentas con pagos', mostrar_front: true, descripcion: 'cuentas_con_pagos', metodo: 'getReportes'}, {nombre:'ventas por cliente', mostrar_front: true, descripcion: 'ventas_cliente', metodo: 'getReportes'}, {nombre:'movimientos de vehiculo', mostrar_front: false, descripcion: 'movimientos_vehiculo', metodo: 'getReportes'}, {nombre:'inventario', mostrar_front: true, descripcion: 'inventario', metodo: 'getReportes'}, {nombre:'suplidor por producto', mostrar_front: true, descripcion: 'suplidor_prod', metodo: 'getReportes'}, {nombre:'cuentas cobrar cliente', mostrar_front: true, descripcion: 'cuentas_cobrar_cliente', metodo: 'getReportes'}, {nombre:'cuentas cobrar con antiguedad de saldo', mostrar_front: true, descripcion: 'cuentas_cobrar_ant_saldo', metodo: 'getReportes'}, {nombre:'cuentas pagar suplidor', mostrar_front: true, descripcion: 'cuentas_pagar_suplidor', metodo: 'getReportes'}, {nombre:'cuentas por pagar con antiguedad de saldo', mostrar_front: true, descripcion: 'cuentas_pagar_ant_saldo', metodo: 'getReportes'}, {nombre:'recibos', mostrar_front: true, descripcion: 'recibos', metodo: 'getReportes'}, { nombre:'Pago de facturas', mostrar_front: true, descripcion: 'pago_facturas', metodo: 'getReportes' }, {nombre:'notas', mostrar_front: true, descripcion: 'notas', metodo: 'getReportes'}]},
	...
	{ nombre:'periodo fiscal',                        mostrar_front: false,     descripcion: 'periodo_fiscal',                   controlador: 'PeriodoFiscal',                  acciones: [ {nombre:'crear', mostrar_front: false, descripcion: 'create', metodo: 'create'}, {nombre:'ver todos', mostrar_front: false, descripcion: 'read_all', metodo: 'index'}, {nombre:'buscar uno', mostrar_front: false, descripcion: 'read_one', metodo: 'show'}, {nombre:'editar', mostrar_front: false, descripcion: 'update', metodo: 'update'}, {nombre:'eliminar', mostrar_front: false, descripcion: 'destroy', metodo: 'destroy'}, { nombre:'abrir nuevo periodo', mostrar_front: false, descripcion: 'open_new_periodo', metodo: 'openNewPeriodo' }]},
  { nombre:'grupos de cuentas contables',           mostrar_front: false,     descripcion: 'grupo_cuenta',                     controlador: 'GrupoCuenta',                    acciones: [ {nombre:'crear', mostrar_front: false, descripcion: 'create', metodo: 'create'}, {nombre:'ver todos', mostrar_front: false, descripcion: 'read_all', metodo: 'index'}, {nombre:'buscar uno', mostrar_front: false, descripcion: 'read_one', metodo: 'show'}, {nombre:'editar', mostrar_front: false, descripcion: 'update', metodo: 'update'}, {nombre:'eliminar', mostrar_front: false, descripcion: 'destroy', metodo: 'destroy'} ]},
  { nombre:'cuentas contables',                     mostrar_front: false,     descripcion: 'cuenta_contable',                  controlador: 'CuentaContable',                 acciones: [ {nombre:'crear', mostrar_front: false, descripcion: 'create', metodo: 'create'}, {nombre:'ver todos', mostrar_front: false, descripcion: 'read_all', metodo: 'index'}, {nombre:'buscar uno', mostrar_front: false, descripcion: 'read_one', metodo: 'show'}, {nombre:'editar', mostrar_front: false, descripcion: 'update', metodo: 'update'}, {nombre:'eliminar', mostrar_front: false, descripcion: 'destroy', metodo: 'destroy'} ]},
  { nombre:'cuentas contables',                     mostrar_front: false,     descripcion: 'cuenta_contable',                  controlador: 'CuentaContable',                 acciones: [ {nombre:'crear', mostrar_front: false, descripcion: 'create', metodo: 'create'}, {nombre:'ver todos', mostrar_front: false, descripcion: 'read_all', metodo: 'index'}, {nombre:'buscar uno', mostrar_front: false, descripcion: 'read_one', metodo: 'show'}, {nombre:'editar', mostrar_front: false, descripcion: 'update', metodo: 'update'}, {nombre:'eliminar', mostrar_front: false, descripcion: 'destroy', metodo: 'destroy'} ]},
  { nombre:'cierre de cuentas contables',           mostrar_front: false,     descripcion: 'cierre_cuenta',                    controlador: 'CierreCuenta',                   acciones: [ {nombre:'crear', mostrar_front: false, descripcion: 'create', metodo: 'create'}, {nombre:'ver todos', mostrar_front: false, descripcion: 'read_all', metodo: 'index'}, {nombre:'buscar uno', mostrar_front: false, descripcion: 'read_one', metodo: 'show'}, {nombre:'editar', mostrar_front: false, descripcion: 'update', metodo: 'update'}, {nombre:'eliminar', mostrar_front: false, descripcion: 'destroy', metodo: 'destroy'} ]},
  { nombre:'configuracion cuentas contables',       mostrar_front: false,     descripcion: 'configuracion_entidad_cuenta',     controlador: 'ConfiguracionEntidadCuenta',     acciones: [ {nombre:'ver todos', mostrar_front: false, descripcion: 'read_all', metodo: 'index'}, {nombre:'buscar uno', mostrar_front: false, descripcion: 'read_one', metodo: 'show'}, {nombre:'editar', mostrar_front: false, descripcion: 'update', metodo: 'update'} ]},
  { nombre:'divisa',                                mostrar_front: false,     descripcion: 'divisa',                           controlador: 'Divisa',                         acciones: [ {nombre:'crear', mostrar_front: false, descripcion: 'create', metodo: 'create'}, {nombre:'ver todos', mostrar_front: false, descripcion: 'read_all', metodo: 'index'}, {nombre:'buscar uno', mostrar_front: false, descripcion: 'read_one', metodo: 'show'}, {nombre:'editar', mostrar_front: false, descripcion: 'update', metodo: 'update'}, {nombre:'eliminar', mostrar_front: false, descripcion: 'destroy', metodo: 'destroy'} ]},
  { nombre:'tasa de cambio',                        mostrar_front: false,     descripcion: 'tasa_cambio',                      controlador: 'TasaCambio',                     acciones: [ {nombre:'ver todos', mostrar_front: false, descripcion: 'read_all', metodo: 'index'}, {nombre:'buscar uno', mostrar_front: false, descripcion: 'read_one', metodo: 'show'}, {nombre:'editar', mostrar_front: false, descripcion: 'update', metodo: 'update'}, {nombre:'obtener historicos de tasas de cambio', mostrar_front: false, descripcion: 'get_history_changes', metodo: 'getHistoryChanges'} ]},
  { nombre:'tipo de cuenta bancaria',               mostrar_front: false,     descripcion: 'tipo_cuenta_bancaria',             controlador: 'TipoCuentaBancaria',             acciones: [ {nombre:'crear', mostrar_front: false, descripcion: 'create', metodo: 'create'}, {nombre:'ver todos', mostrar_front: false, descripcion: 'read_all', metodo: 'index'}, {nombre:'buscar uno', mostrar_front: false, descripcion: 'read_one', metodo: 'show'}, {nombre:'editar', mostrar_front: false, descripcion: 'update', metodo: 'update'}, {nombre:'eliminar', mostrar_front: false, descripcion: 'destroy', metodo: 'destroy'} ]},
  { nombre:'banco',                                 mostrar_front: false,     descripcion: 'banco',                            controlador: 'Banco',                          acciones: [ {nombre:'crear', mostrar_front: false, descripcion: 'create', metodo: 'create'}, {nombre:'ver todos', mostrar_front: false, descripcion: 'read_all', metodo: 'index'}, {nombre:'buscar uno', mostrar_front: false, descripcion: 'read_one', metodo: 'show'}, {nombre:'editar', mostrar_front: false, descripcion: 'update', metodo: 'update'}, {nombre:'eliminar', mostrar_front: false, descripcion: 'destroy', metodo: 'destroy'} ]},
  { nombre:'cuenta_bancaria',                       mostrar_front: false,     descripcion: 'cuenta_bancaria',                  controlador: 'CuentaBancaria',                 acciones: [ {nombre:'crear', mostrar_front: false, descripcion: 'create', metodo: 'create'}, {nombre:'ver todos', mostrar_front: false, descripcion: 'read_all', metodo: 'index'}, {nombre:'buscar uno', mostrar_front: false, descripcion: 'read_one', metodo: 'show'}, {nombre:'editar', mostrar_front: false, descripcion: 'update', metodo: 'update'}, {nombre:'eliminar', mostrar_front: false, descripcion: 'destroy', metodo: 'destroy'} ]},
  { nombre:'asiento contable',                      mostrar_front: false,     descripcion: 'cabeza_asiento_contable',          controlador: 'CabezaAsientoContable',          acciones: [ {nombre:'crear', mostrar_front: false, descripcion: 'create', metodo: 'create'}, {nombre:'ver todos', mostrar_front: false, descripcion: 'read_all', metodo: 'index'}, {nombre:'buscar uno', mostrar_front: false, descripcion: 'read_one', metodo: 'show'}, {nombre:'editar', mostrar_front: false, descripcion: 'update', metodo: 'update'}, {nombre:'eliminar', mostrar_front: false, descripcion: 'destroy', metodo: 'destroy'} ]},
  { nombre:'categoria de entidad contable',         mostrar_front: false,     descripcion: 'categoria_entidad_contable',       controlador: 'CategoriaEntidadContable',       acciones: [ {nombre:'crear', mostrar_front: false, descripcion: 'create', metodo: 'create'}, {nombre:'ver todos', mostrar_front: false, descripcion: 'read_all', metodo: 'index'}, {nombre:'buscar uno', mostrar_front: false, descripcion: 'read_one', metodo: 'show'}, {nombre:'editar', mostrar_front: false, descripcion: 'update', metodo: 'update'} ]},
  { nombre:'entidad cuenta contable',               mostrar_front: false,     descripcion: 'entidad_cuenta_contable',          controlador: 'EntidadCuentaContable',          acciones: [ {nombre:'crear', mostrar_front: false, descripcion: 'create', metodo: 'create'}, {nombre:'ver todos', mostrar_front: false, descripcion: 'read_all', metodo: 'index'}, {nombre:'buscar uno', mostrar_front: false, descripcion: 'read_one', metodo: 'show'}, {nombre:'editar', mostrar_front: false, descripcion: 'update', metodo: 'update'} ]},
  { nombre:'deposito',                              mostrar_front: false,     descripcion: 'deposito',                         controlador: 'Deposito',                       acciones: [ {nombre:'crear', mostrar_front: false, descripcion: 'create', metodo: 'create'}, {nombre:'ver todos', mostrar_front: false, descripcion: 'read_all', metodo: 'index'}, {nombre:'buscar uno', mostrar_front: false, descripcion: 'read_one', metodo: 'show'}, {nombre:'editar', mostrar_front: false, descripcion: 'update', metodo: 'update'}, {nombre:'anular deposito', mostrar_front: false, descripcion: 'anular_deposito', metodo: 'anularDeposito'} ]},
  { nombre:'transferencia',                         mostrar_front: false,     descripcion: 'transferencia',                    controlador: 'Transferencia',                  acciones: [ {nombre:'crear', mostrar_front: false, descripcion: 'create', metodo: 'create'}, {nombre:'ver todos', mostrar_front: false, descripcion: 'read_all', metodo: 'index'}, {nombre:'buscar uno', mostrar_front: false, descripcion: 'read_one', metodo: 'show'}, {nombre:'editar', mostrar_front: false, descripcion: 'update', metodo: 'update'}, {nombre:'anular transferencia', mostrar_front: false, descripcion: 'anular_transferencia', metodo: 'anularTransferencia'} ]},
  { nombre:'cheque',                                mostrar_front: false,     descripcion: 'cheque',                           controlador: 'Cheque',                         acciones: [ {nombre:'crear', mostrar_front: false, descripcion: 'create', metodo: 'create'}, {nombre:'ver todos', mostrar_front: false, descripcion: 'read_all', metodo: 'index'}, {nombre:'buscar uno', mostrar_front: false, descripcion: 'read_one', metodo: 'show'}, {nombre:'editar', mostrar_front: false, descripcion: 'update', metodo: 'update'}, { nombre:'anular cheque', mostrar_front: false, descripcion: 'anular_cheque', metodo: 'anularCheque'}, { nombre: 'buscar filtrados', mostrar_front: false, descripcion: 'get_filtrados', metodo: 'getChequesFiltrados' } ]},
  { nombre:'Recepcion Ecf',                         mostrar_front: false,     descripcion: 'ecf_reception',                     controlador: 'EcfReception',                   acciones: [READ_ALL_ACTION, READ_ONE_ACTION, { nombre: 'Responder recibo de factura', mostrar_front: false, descripcion: 'response_receive', metodo: 'approveDenyEcf'}]},
  { nombre:'Aprobaciónes comerciales',              mostrar_front: false,     descripcion: 'commertial_approval_reception',     controlador: 'CommertialApprovalReception',    acciones: [READ_ALL_ACTION, READ_ONE_ACTION]}
]
