...
class ContenidoArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contenido_articulo" do
    assert_difference('ContenidoArticulo.count') do
      post contenido_articulos_url, params: { contenido_articulo: { articulo_id: @contenido_articulo.articulo_id, calcular_itbis: @contenido_articulo.calcular_itbis, cantidad: @contenido_articulo.cantidad, condicion: @contenido_articulo.condicion, costo: @contenido_articulo.costo, medida: @contenido_articulo.medida, precio: @contenido_articulo.precio, referencia: @contenido_articulo.referencia } }, as: :json
    end
  ...
  test "should update contenido_articulo" do
    patch contenido_articulo_url(@contenido_articulo), params: { contenido_articulo: { articulo_id: @contenido_articulo.articulo_id, calcular_itbis: @contenido_articulo.calcular_itbis, cantidad: @contenido_articulo.cantidad, condicion: @contenido_articulo.condicion, costo: @contenido_articulo.costo, medida: @contenido_articulo.medida, precio: @contenido_articulo.precio, referencia: @contenido_articulo.referencia } }, as: :json
    assert_response 200
  end
