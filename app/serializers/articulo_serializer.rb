class ArticuloSerializer < ActiveModel::Serializer
  ...
  attribute :sub_tipo_articulo_id,               if: Proc.new { self.get_param('all') || self.get_param('sub_tipo_articulo_id')}
  ...
  attribute :sub_tipo_articulo,                  if: Proc.new { self.get_param('all') || self.get_param('sub_tipo_articulo')}
  ...
  def sub_tipo_articulo
    object.sub_tipo_articulo
  end
