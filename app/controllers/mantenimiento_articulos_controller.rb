class MantenimientoArticulosController < ApplicationController
  ...
  def mantenimiento_articulo_params
    params.require(:mantenimiento_articulo).permit(:articulo_id, :user_id, :ant_medidaAlerta, :ant_nombre, :ant_tipoArticulo, :ant_suplidor, :ant_medida, :ant_costoP, :ant_precioP, :ant_alertaExistencia, :ant_isDetallable, :ant_tipoArticuloId, :ant_medidaPadre,
