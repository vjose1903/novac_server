  ...
  def self.create_update_cuenta_bancaria(params, banco, is_save=false)
    ...
    unless banco.nil?
      CuentaBancaria.transaction do
        ...
        cuenta_bancaria.balance_inicial_libro      = params[:balance_inicial_libro] if params[:balance_inicial_libro].present? && !params[:balance_inicial_libro].nil?
        cuenta_bancaria.balance_inicial_banco      = params[:balance_inicial_banco] if params[:balance_inicial_banco].present? && !params[:balance_inicial_banco].nil?
